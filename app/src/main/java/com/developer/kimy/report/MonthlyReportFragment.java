...
public class MonthlyReportFragment extends Fragment implements MonthlyReportContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mHistoryAdapter = new HistoryAdapter(new ArrayList<PillHistory>());
    ...
    @Override
    public void showHistoryList(List<PillHistory> pillHistoryList) {
        mHistoryAdapter.replaceData(pillHistoryList);
