...
public class MedicinesLocalDataSource implements MedicineDataSource {
    ...
    public void getMedicineHistory(LoadHistoryCallbacks loadHistoryCallbacks) {
        List<PillHistory> pillHistoryList = mDbHelper.getHistory();
        loadHistoryCallbacks.onHistoryLoaded(pillHistoryList);
    }
    ...
    public void saveToHistory(PillHistory pillHistory) {
        mDbHelper.createHistory(pillHistory);
    }
    ...
    public void addToHistory(PillHistory h) {
