...
import com.developer.kimy.views.DayViewCheckBox;
...
public class AddPillFragment extends Fragment implements AddPillContract.View {
    ...
    private AddPillContract.Presenter mPresenter;
    ...
    static AddPillFragment newInstance() {
    ...
    @Override
    public void setPresenter(AddPillContract.Presenter presenter) {
