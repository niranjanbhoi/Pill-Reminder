...
public class AddPillPresenter implements AddPillContract.Presenter, MedicineDataSource.GetTaskCallback {

    @NonNull
    private final MedicineDataSource mMedicineRepository;

    private final AddPillContract.View mAddMedicineView;

    private int mMedicineId;

    private boolean mIsDataMissing;

    public AddPillPresenter(int mMedicineId, @NonNull MedicineDataSource mMedicineRepository, AddPillContract.View mAddMedicineView, boolean mIsDataMissing) {
