package com.developer.kimy.data;
...
public class FakeMedicineLocalDataSource implements MedicineDataSource {
    ...
    private static final Map<String, PillHistory> HISTORY_SERVICE_DATA;
    ...
    private static void addHistory(int hourTaken, int minuteTaken, String dateString, String pillName, int action, String doseQuantity, String doseUnit, int alarmId) {
        PillHistory pillHistory = new PillHistory(hourTaken, minuteTaken, dateString, pillName, action, doseQuantity, doseUnit, alarmId);
        HISTORY_SERVICE_DATA.put(pillName, pillHistory);
    }
    ...
    public void getMedicineHistory(LoadHistoryCallbacks loadHistoryCallbacks) {
        loadHistoryCallbacks.onHistoryLoaded(new ArrayList<PillHistory>(HISTORY_SERVICE_DATA.values()));
    }
    ...
    @Override
    public void saveToHistory(PillHistory pillHistory) {
        HISTORY_SERVICE_DATA.put(String.valueOf(pillHistory.getPillName()), pillHistory);
    }
}
